...
//! A Hardware Abstraction Layer for the Hatlet version 0.1.0.
//!
//! This crate serves as a HAL (Hardware Abstraction Layer) for Hatlet. Since the Hatlet is based on the RP2040 chip,
//! it re-exports the [rp2040_hal] crate which contains the tooling to work with the rp2040 chip.
//!
//! # Examples:
//!
